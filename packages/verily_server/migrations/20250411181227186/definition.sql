...
CREATE TABLE "action" (
    ...
    "maxCompletionTimeSeconds" bigint,
    "strictOrder" boolean NOT NULL DEFAULT true,
...
--
-- Class Creator as table creator
--
...
--
-- Class VerificationAttempt as table verification_attempt
--
...
--
-- Class Webhook as table webhook
--
...
--
-- Foreign relations for "verification_attempt" table
--
...
--
-- Foreign relations for "webhook" table
--
