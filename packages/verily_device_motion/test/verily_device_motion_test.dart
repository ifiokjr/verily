...
void main() {
  ...
  const methodChannelAccelerometer =
      'dev.fluttercommunity.plus/sensors/accelerometer';
  const eventChannelAccelerometer =
      'dev.fluttercommunity.plus/sensors/accelerometer_event';
  const methodChannelGyroscope = 'dev.fluttercommunity.plus/sensors/gyroscope';
  const eventChannelGyroscope =
      'dev.fluttercommunity.plus/sensors/gyroscope_event';
          ...
          if (methodCall.method == 'listen') {
            ...
            TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
                .setMockMessageHandler(
                  channelName.replaceFirst('_event', ''),
                  null,
                ); // Assumes event channel name derivation
            return null;
          }
          return null;
        });
  ...
  tearDown(() {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(
          MethodChannel(methodChannelAccelerometer),
          null,
        );
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
  ...
  group('MotionDetectorService', () {
    ...
    test('detects drop after freefall and impact', () async {
        ...
        emits(
          isA<MotionEvent>()
              ...
              .having(
                (e) => e.value,
                'value',
                greaterThan(effectiveImpactThreshold),
              ),
        ),
      );
      ...
      ); // Wait past detection reset delay
